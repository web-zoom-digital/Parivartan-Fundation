...
export function Footer() {
  return (
    <footer className="bg-slate-900 pt-14 sm:pt-20 pb-28 lg:pb-10 text-slate-300">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          {/* Brand */}
          <div className="flex flex-col gap-6">
            <Link href="/" className="flex items-center">
              <div className="h-12 sm:h-16 w-auto relative flex items-center justify-start group-hover:scale-105 transition-transform duration-300 bg-white p-2 rounded-xl">
            ...
            <div className="flex gap-4">
              <a
                href="mailto:hello@nabinchandrafoundation.org"
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-emerald-600 hover:text-white transition-colors"
              >
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              {[
                ...
                <li key={link.label}>
                  <Link href={link.href} className="text-sm hover:text-blue-400 transition-colors flex items-center gap-2">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-sm">hello@nabinchandrafoundation.org</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-1.5">
            ...
            <p className="text-xs text-slate-600">
              Designed, Developed & SEO Managed by <a href="https://www.zoomdigital.in" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-400 font-medium transition-colors">Zoom Digital</a>
            </p>
          </div>
