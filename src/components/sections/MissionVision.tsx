...
export function MissionVision() {
  return (
    <section className="section-spacing bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-1/2 h-full bg-blue-50/50 rounded-l-[100px] pointer-events-none" />
      ...
      <div className="container-custom relative z-10">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-blue-100 rounded-bl-[100px] -z-10 transition-transform duration-500 hover:scale-110" />
            <div className="w-16 h-16 rounded-2xl bg-blue-600 flex items-center justify-center mb-8 shadow-lg shadow-blue-600/20">
