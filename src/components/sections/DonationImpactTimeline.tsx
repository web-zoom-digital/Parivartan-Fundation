...
const steps = [
  {
    ...
    desc: "Supporters and well-wishers contribute funds to help us arrange meals, blankets, and saplings — every single rupee counts.",
    gradient: "from-rose-500 to-pink-500",
    softBg: "bg-rose-50",
    border: "border-rose-200",
    glow: "shadow-rose-200",
    image: "/images/food_distribution/food_distribution_1.jpeg",
    alt: "Parivartan Welfare Society food drive",
  },
  {
    num: "02",
    emoji: "📋",
    title: "Identifying Needy Areas",
    desc: "Our volunteer team surveys local localities and street locations to identify elderly people, daily workers, and families most in need.",
    gradient: "from-blue-600 to-blue-400",
    softBg: "bg-[#eef2eb]",
    border: "border-[rgba(35,54,29,0.2)]",
    glow: "shadow-blue-200",
    image: "/images/blanket_distribution/blanket_distribution_1.jpeg",
    alt: "Winter blanket distribution planning and drive",
  },
  {
    num: "03",
    emoji: "🛒",
    title: "Procuring Essentials",
    desc: "We buy fresh ration ingredients, high-quality thick blankets, and green tree saplings directly from local vendors.",
    gradient: "from-orange-500 to-amber-400",
    softBg: "bg-orange-50",
    border: "border-orange-200",
    glow: "shadow-orange-200",
    image: "/images/plantation/plantation_image_1.jpeg",
    alt: "Plantation saplings and community drives",
  },
  {
    num: "04",
    emoji: "🚚",
    title: "Ground Distribution",
    desc: "Our volunteers directly hand over hot meals, warm blankets, and plant saplings with love, care, and respect.",
    gradient: "from-emerald-600 to-emerald-400",
    softBg: "bg-[#f0f2ef]",
    border: "border-emerald-200",
    glow: "shadow-emerald-200",
    image: "/images/food_distribution/food_distribution_4.jpeg",
    alt: "Volunteers serving cooked food to community members",
  },
  {
    num: "05",
    emoji: "📈",
    title: "Sharing Ground Updates",
    desc: "We photograph and document every drive, posting real photos on our site so donors see their contributions at work.",
    gradient: "from-purple-600 to-purple-400",
    softBg: "bg-purple-50",
    border: "border-purple-200",
    glow: "shadow-purple-200",
    image: "/images/blanket_distribution/blanket_distribution_5.jpeg",
    alt: "Ground documentation and transparency",
  },
]
    ...
    <section className="section-spacing bg-white relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        <motion.div
          ...
          className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#23361D] via-[#1b2916] to-[#2e4626] p-12 text-white text-center shadow-2xl shadow-[rgba(35,54,29,0.25)]">
          {/* Background decoration */}
          <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#C37C24]/15 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl pointer-events-none" />
          ...
          <div className="relative z-10">
            <motion.div
              ...
              <Heart className="w-10 h-10 text-[#C37C24] fill-[#C37C24]" />
            </motion.div>
            <h3 className="text-3xl lg:text-4xl font-extrabold mb-4 leading-tight text-white">
