        ...
        <div className="container-custom">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              { icon: Phone, title: "Call Us", lines: ["+91 93158 14894", "Mon–Sat, 9am–7pm"], color: "from-emerald-600 to-teal-400", action: "tel:+919315814894" },
              { icon: Mail, title: "Email Us", lines: ["hello@nabinchandrafoundation.org", "Reply within 24 hours"], color: "from-orange-500 to-amber-400", action: "mailto:hello@nabinchandrafoundation.org" },
              {
                icon: () => (
                ...
                title: "WhatsApp", lines: ["+91 93158 14894", "Quick responses"], color: "from-[#25D366] to-[#128C7E]", action: "https://wa.me/919315814894"
              },
            ].map((c, i) => {
              const Icon = c.icon
              const card = (
          ...
          <div className="grid lg:grid-cols-2 gap-14">
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" custom={0.2} viewport={{ once: true }} className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-orange-500 to-amber-400 rounded-2xl p-7 text-white">
                ...
                <a href="tel:+919315814894" className="inline-flex items-center gap-2 bg-white text-orange-600 font-black text-lg px-6 py-3 rounded-full hover:bg-orange-50 transition-colors">
                  <Phone className="w-5 h-5" /> +91 93158 14894
                </a>
              </div>
